export interface Experience {
  ...
  description: string;
  image?: string;
  tags?: string[];        // soft-skill tags — used for profile page filtering
  gradient: {
    from: string;
    to: string;
  };
...
export const allExperiences: Experience[] = [
  ...
  },
  {
    ...
    tags: ["Leadership", "Problem Solving", "Team Collaboration", "Critical Thinking"],
    gradient: {
  ...
  },
  {
    ...
    tags: ["Leadership", "Communication Skills", "Team Collaboration", "Time Management"],
    gradient: {
      from: "from-green-500",
      to: "to-emerald-600"
    },
  ...
  },
  {
    ...
    tags: ["Problem Solving", "Critical Thinking", "Analytical Thinking"],
    gradient: {
  ...
  },
  {
    ...
    tags: ["Communication Skills", "Leadership", "Adaptability", "Time Management"],
    gradient: {
      from: "from-blue-500",
      to: "to-purple-600"
    },
  ...
  },
  {
    ...
    tags: ["Communication Skills", "Team Collaboration", "Time Management", "Leadership"],
    gradient: {
      from: "from-green-500",
      to: "to-teal-600"
    },
  ...
  },
  {
    ...
    tags: ["Team Collaboration", "Communication Skills", "Time Management"],
    gradient: {
  ...
  },
  {
    ...
    tags: ["Leadership", "Team Collaboration", "Communication Skills", "Time Management"],
    gradient: {
      from: "from-pink-500",
      to: "to-purple-600"
    },
